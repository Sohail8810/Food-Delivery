...
const LoginPop = ({ setShowLogin }) => {
    ...
    const [currState, setCurrent] = useState("login")
        ...
        <div className='login-pop'>
            <form onSubmit={onLogin} className='login-pop-container'>
                ...
                <div className="login-pop-inputs">
                    ...
                    <input name='password' onChange={onChangeHandle} value={data.password} type="password" placeholder='Your password' required />
                </div>
